...
class VisualEvidenceBaselineTest {
    ...
    fun `current APK visual gate renders and archives every required system profile`() {
        ...
        assertContains(testSource, "v3ControlBoundsPx")
        assertContains(testSource, "V3_CONTROL_RESOURCES")
        ...
        assertContains(landscapeThreeButtonTestSource, "V3_CONTROL_RESOURCES")
